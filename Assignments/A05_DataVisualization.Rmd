...
lakegrid <- plot_grid(lakeplot2 + theme(legend.position="none"), lakeplot3 + theme(legend.position="none"), lakeplot4 + theme(legend.position="none"), align ="v", ncol = 3, rel_heights = c(1.25, 1))
