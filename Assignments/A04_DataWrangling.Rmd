...
dim(EPA_data_filtered)

#9
EPA_data_spread <- pivot_wider(EPA_data_filtered, names_from = AQS_PARAMETER_DESC, values_from = meanAQI)

#10
dim(EPA_data_spread)

#11 DONT RUN UNTIL YOU FIX YOUR DIMENSIONS
write.csv(EPA_data_spread, row.names = FALSE, file = "./Data/Processed/EPAair_O3_PM25_NC2122_Processed.csv")
